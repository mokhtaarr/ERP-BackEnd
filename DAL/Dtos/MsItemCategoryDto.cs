...
namespace DAL.Dtos
{
    public class MsItemCategoryDto
    {
        ...
        public string Name_ParentItemCategoryId { get; set; } = string.Empty;
        public string NameEn_ParentItemCategoryId { get; set; } = string.Empty;
